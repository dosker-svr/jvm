...
## Пояснение:
 ...
 - [3] int i = 1;// 3 - во frame(под main), выделяется место для !примитивов. и в этот frame добавляем примитив int i = 1
        
 - [4] Object o = new Object(); // 4 - в heap создаётся объект Object, а в Stack добавляется ссылка-переменная на этот объект(в куче)
 ...
 - [9] System.out.println(o.toString() + i + ii); /* 9 - загрузится класс PrintStream. далее в Stack создастся ещё один frame(под println).
